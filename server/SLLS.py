...
prompt = st.text_input(
    "Put your English paragraph for getting correct grammar and pronunciation.")
...
if prompt:
    ...
    # Store the title response for the second sequence
    response_title_second_text = response_title_second
